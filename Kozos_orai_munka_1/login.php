...
<form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
    <div class="mb-3">
        <label class="form-label text_color1 bold_style">User name</label>
    ...
    <div class="mb-3">
        <label class="form-label text_color1 bold_style">Password</label>
    ...
    <div>
        <button id="registerButton" type="submit" class="btn btn-primary color5 bold_style">Login</button>
